...
void lcd_writedata(unsigned char dat)
{
    ...
    lcd_writenibble(dat & 0xf0);
    /* Call lcd_writenibble to send LOWER four bits of "dat" argument */
    lcd_writenibble((dat & 0x0f) << 4);
    /* Delay 2ms */
    _delay_ms(2);
}

// ((1 << PD7)|(1 << PD6)|(1 << PD5)|(1 << PD4))
/*
...
void lcd_writenibble(unsigned char lcdbits)
{
    ...
    PORTB |= (1 << PB1); // Set E to 1 for 125ms
    PORTB |= (1 << PB1); // Make E longer for another 125ms
